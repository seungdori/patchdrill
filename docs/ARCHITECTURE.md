...
| `src/dependency.ts` | Extracts package.json, requirements.txt, npm, pnpm, Yarn, Bun, Go, Cargo, Poetry, Pipfile, Bundler, and Composer dependency additions, removals, and version updates. |
