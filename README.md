...
- Works with the tools you already have: git, npm, pnpm, yarn, bun, pytest, Django, cargo, Go, Maven, Gradle, Spring Boot, Android Gradle, dotnet, Swift, Terraform, Docker, Kubernetes, Helm, Bazel, and Buck2.
...
- Includes first-party stack fixtures for Node/Turborepo, Next.js, Python, Django, Rails, PHP/Composer, Terraform, Kubernetes/Helm/Kustomize, Java/Gradle, Spring Boot, Android Gradle, .NET, SwiftPM, Bazel, Buck2, Pants, Cargo, and Go repository shapes.
