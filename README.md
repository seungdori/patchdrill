...
- package.json, pyproject.toml, requirements.txt, NuGet PackageReference and central PackageVersion files, Gemfile, composer.json, npm package-lock, pnpm-lock, yarn.lock, bun.lock, go.sum, Cargo.lock, poetry.lock, uv.lock, Pipfile.lock, Gemfile.lock, and composer.lock dependency additions, removals, and updates.
